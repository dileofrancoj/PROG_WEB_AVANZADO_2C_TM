...
async function getContenidos(idCliente) {
    try {
        let query = "select id_contenido, precio_contenido, link_contenido, titulo_contenido, descripcion_contenido, multimedia_contenido, fecha_contenido from ?? where id_cliente_contenido = ? and estado_contenido = 1 order by id_contenido desc";
