...
const comprasRouter = require('./controllers/compras');
const usuariosRouter = require('./controllers/usuarios');
const mailingRouter = require('./controllers/mailing');
const notificacionRouter = require('./controllers/notificacion');
const domicilioRouter = require('./controllers/domicilio');
// Admin controller
...
app.use('/compras', secured,comprasRouter);
app.use('/usuarios', secured,usuariosRouter);
app.use('/domicilio', secured, domicilioRouter)
